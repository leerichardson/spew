...
- format.R 
  ...
  - How can we differentiate when we are sampling number of total people compared 
with just a total number of households?? 
 - Need to make sure we are using the correct "level" for counts. Will keep them all in read/standardize, and then find the appropriate level in "format"!
