...
\section{Introduction}
	This document provides specific details version 1.2.0 of SPEW synthetic ecosystems were generated. All ecosystems are generated with the R package, \verb|spew|. SPEW ecosystems are synchronized with our software, so SPEW 1.2.0 ecosystems are all generated with version 1.2.0 of the software. The \verb|spew| R package and supplementary code is available online at: \\
	
	\url{https://github.com/leerichardson/spew} \\

	SPEW 1.2.0 contains 126 synthetic ecosystems, grouped into three categories:: United States, IPUMS, and Custom. The United States has 52 synthetic ecosystems, one for each state. Each US synthetic ecosystem is a union of tract-level synthetic ecosystems, paired with school and workplace environments. There are 73 IPUMS synthetic ecosystems, each corresponding to a specific country. We refer to these as IPUMS synthetic ecosystems, because they were generated using IPUMS microdata and Shapefiles. IPUMS synthetic ecosytems are unions of administrative level 1 synthetic ecosystems. Finally, we have generated one Custom synthetic ecosystem for Canada, using input data from Statistics Canada. Like the US, the Canada synthetic ecosystem is a union of tract-level ecosostems. The details of SPEW 1.2.0 ecosystems are summarize in Table \ref{tab:spew_1.2.0}. 

	\begin{table}[h!]
	\label{tab:spew_1.2.0}
	\caption{Summary of SPEW 1.2.0 Synthetic Ecosystem Characteristics}
	\begin{tabular}{ |c|c|c|c|c|c| } 
		\hline
		Group & Total & Level & Characteristics & Spatial & Environments \\ 
		\hline \hline 
		United States & 52 & Tract & IPF & Road-Based & Schools, Workplaces \\ 
		IPUMS & 73 & Level 1 & SRS & Uniform & None \\ 
		Custom & 1 & Tract & SRS & Uniform & None \\ 
		\hline
	\end{tabular}
	\end{table}	

	There are two key improvements to SPEW 1.2.0 ecosystems. First, the United States population characteristics are generated using an Iterative Proportional Fitting (IPF) sampling scheme. Second, each ecosystem is paired with a diagnostic report, summarizing the contents of the ecosystem. 
