...
The **data/** and **data-raw/** folders have example data for testing new R-code, both locally and against data (as it is) on Olympus. 
...
Describe the file hierarchy of SPEW ecosystems (ours is complicated). 
