...
### Household Income
 Below is a histogram of the yearly household income ($).
 ```{r, echo = FALSE, message = FALSE, warning = FALSE}
 hh_sf <- lapply(hh_list, "[[", 2)
...
### Male to Female Ratio
 ...
 Below is a bar chart of male to female ratio
...
### Age
 ...
 Below is a bar chart of age ratios per region
```{r, echo = FALSE,  message = FALSE, warning = FALSE, fig.align = 'center', fig.height = 6}
p_sf <- lapply(p_list, "[[", 2)
p_mf <- lapply(p_sf, "[[", 1)
regions <- df$Region
...
### Race
 ...
 Below is a bar chart of race ratios per region
```{r, echo = FALSE,  message = FALSE, warning = FALSE, fig.align = 'center', fig.height = 6}
p_sf <- lapply(p_list, "[[", 2)
p_mf <- lapply(p_sf, "[[", 1)
regions <- df$Region
