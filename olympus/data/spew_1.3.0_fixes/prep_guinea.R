...
input_path <- "/mnt/beegfs1/data/shared_group_data/syneco/spew_input/africa/western_africa/gin/input"

out_pt <- paste0(input_path, "/counts/geohive/2014/1/guinea_revised.csv")
out_shape <- paste0(input_path, "/shapefiles/ipums/1996/1/guinea_revised")
...
# pop_table <- spew:::combine_counts(pop_table, "", "")
# pop_table <- spew:::combine_counts(pop_table, "", "")
# pop_table <- spew:::combine_counts(pop_table, "", "")
