...
input_path <- "/mnt/beegfs1/data/shared_group_data/syneco/spew_input/africa/western_africa/sle/input"

out_pt <- paste0(input_path, "/counts/geohive/2015/2/sierraleone_revised.csv")
out_shape <- paste0(input_path, "/shapefiles/ipums/2004/1/sierra_leone_revised")
...
# Clean the names of their non ascii character, uppercases, and spaces 
...
# MAKE CHANGES HERE ----------------------------
# ----------------------------------------------
count_names <- gsub(pattern = "district", replacement = "", x = count_names)
