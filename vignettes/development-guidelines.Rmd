...
Note that you will be prompted to install packages for a personal library when you do this, but just type `y` when prompted and everything should work smoothly. Specifically, the package will be now installed in your home directory, which you can see with:

```{r}
# The directory spew is installed into is the one corresponding to /home/USERNAME 
# on Olympus....
.libPaths()
```
