...
Note that you will be prompted to install packages for a personal library when you do this, but just type `y` when prompted and everything should work smoothly. 
