...
in_dir <- "/data/shared_group_data/syneco/input/east/asia/bangladesh"
out_dir <- "/data/shared_group_data/syneco/outputs/spew/east/asia/bangladesh/"
...
generate_spew(input_dir = in_dir, output_dir = out_dir, folders = folders, 
              ...
              convert_count = convert_count, vars = vars)
```
