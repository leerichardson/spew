...
# in_dir <- "/mnt/beegfs1/data/shared_group_data/syneco/input/west/north_america/united_states/72/input"
# out_dir <- "/mnt/beegfs1/data/shared_group_data/syneco/test/united_states/72/"
# if (in_dir == "/mnt/beegfs1/data/shared_group_data/syneco/input/west/north_america/united_states/72/input") {
#   folders <- list(pop_table = "popTables", 
#                       pums = "pums/2013", 
#                       lookup = "tables", 
#                       shapefiles = "tiger")
