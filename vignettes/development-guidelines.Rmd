...
in_dir <- "/data/shared_group_data/syneco/input/east/africa/zambia"
out_dir <- "/data/shared_group_data/syneco/outputs/spew/east/africa/zambia/"
...
generate_spew(input_dir = in_dir, output_dir = out_dir, folders = folders, 
              parallel = FALSE, data_group, sampling_type = "uniform", 
              convert_count = convert_count, vars = vars, make_plots=TRUE)
