...
in_dir <- "/data/shared_group_data/syneco/input/west/north_america/united_states/46"
out_dir <- "/mnt/beegfs1/data/shared_group_data/syneco/south_dakota/"

generate_spew(input_dir = in_dir, output_dir = out_dir, folders = folders, 
              parallel = TRUE, data_group, sampling_type = "uniform", 
              convert_count = convert_count, vars = vars, make_plots = FALSE)
```
